...
class Contents {
  ...
  textWidth() {
    ...
    let border = Object(_utils_core__WEBPACK_IMPORTED_MODULE_1__["borders"])(content);
    ...
    _createClass(Highlight, [{
        ...
        value: function render() {
            ...
            for (var i = 0, len = filtered.length; i < len; i++) {
                ...
                circle.setAttribute("cx", r.left - offset.left + container.left);
                circle.setAttribute("cy", r.top - offset.top + container.top);
                circle.setAttribute("r", "10");
                circle.setAttribute("fill-opacity", "0.3");
                circle.setAttribute("fill", "blue");
                // Create an SVG wrapper for the inner SVG
                ...
                // Insert the provided inner SVG content (you may need to manually parse and append child elements)
                innerSvg.innerHTML = '\n            <g>\n                <g id="XMLID_28_">\n                <g>\n                    <path style="fill:#FFFFFF;" d="M437.029,439.43c0,0.79-0.31,1.54-0.87,2.1c-1.12,1.11-3.08,1.12-4.2,0l-11.91-11.92l4.2-4.19 l11.91,11.91C436.719,437.89,437.029,438.64,437.029,439.43z"></path>\n                    <path style="fill:#4489D3;" d="M44.389,23.64c2.51-2.51,5.85-3.9,9.41-3.9c3.55,0,6.9,1.39,9.41,3.9l9.13,9.13l-44.94,44.94 l-9.13-9.13c-2.51-2.52-3.9-5.86-3.9-9.41c0-3.56,1.39-6.9,3.9-9.41L44.389,23.64z"></path>\n                </g>\n                </g>\n            </g>\n            ';
...
class rendition_Rendition {
  ...
  start() {
    ...
    // Listen for resizing
    this.manager.on(constants["c" /* EVENTS */].MANAGERS.RESIZED, this.onResized.bind(this));
...
class IframeView {
  ...
  highlight(cfiRange, data = {}, cb, className = "epubjs-hl", styles = {}, attachment = {}) {
    ...
    let m = new marks_pane__WEBPACK_IMPORTED_MODULE_5__["Highlight"](range, className, data, attributes, attachment);
