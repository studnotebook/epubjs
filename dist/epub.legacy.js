    ...
    _createClass(Highlight, [{
        ...
        value: function render() {
            ...
            for (var i = 0, len = filtered.length; i < len; i++) {
                ...
                text.setAttribute("x", r.left - offset.left + container.left);
                text.setAttribute("y", r.top - offset.top + container.top);
                text.setAttribute("fill", "white");
                text.setAttribute("font-size", "14px");
                text.setAttribute("font-family", "Arial");
                text.setAttribute("font-weight", "bold");
                text.textContent = "A"; // Set text content

                // Append elements to the SVG container (assuming `svg` is already defined in your document)
